...
1. Click to see how to [filter](../3-Data_Wrangling_Visualization/02-Filter.qmd) out Ambitextrous participants and reaction time outliers (reaction times less than 1 seconds):
