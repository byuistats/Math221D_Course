...
When we want to compare 3 or more groups, the math get's more complicated.  Analysis of Variance (ANOVA) compares how spread out the means are relative to the average _within_ group variation. 
...
Instead of checking for normality of each of the groups separately,  
