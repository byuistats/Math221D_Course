...
For continuous probability distributions, the Calculus is required to calculate these quantities.  Fortunately, you do *NOT* need to know any calculus for this class because computers will perform all the calculations for us.  However, it is important to understand a few basic principles for continuous probability distributions.  
