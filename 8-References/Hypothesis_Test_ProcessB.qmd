...
# Hypothesis Test Conclusions  
  ...
  1. $\text{P-value} < \alpha$:  
      ...
      * **Sufficient Evidence** to support the alternative  
        i.  Bring back to context of the research question.  For example: I have sufficient evidence to suggest that Brother Cannon's students are, on average, more agreeable than the general population.  
  ...
  2. $\text{P-value} \ge \alpha$:  
      ...
      * **Insufficient Evidence** to support the alternative  
        i.  Bring back to context of the research question.  For example: I have insufficient evidence to suggest that Brother Cannon's students are, on average, less open than the general population.  