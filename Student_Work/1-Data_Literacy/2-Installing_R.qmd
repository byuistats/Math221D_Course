...
Throughout this course, you will download many files. The collection of files will be a valuable resource if you go on to use R in the future.
  ...
  1. Create a folder somewhere on your computer or OneDrive that is easy to find. Consider naming it "M221D" or another descriptive name.
...
If everything worked, R should open up a browser window with some text and a chart. If it runs, you're technology is set up for success in this class. 

Once you have "Rendered" the document, R will also create a `.html` file in the same file location where you saved your Student_Work folder.  If you have followed the above instructions, the file path will look like "/Student_Work/1-Data_Literacy/TestingTesting.html". 

__Upload the "TestingTesting.html"__ file into Canvas to show that it works.  


## Keep Calm

If you have tried going through these instructions and it isn't working, come to class and we can help troubleshoot.  
