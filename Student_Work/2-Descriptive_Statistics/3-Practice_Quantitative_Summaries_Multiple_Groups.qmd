...
In this dataset, we find a **quantitative response** variable and *categorical explanatory* variables.  We will summarize the response variable for each level of explanatory variables of interest.  
