...
To look at the relationship between 2 quantitative variables, we use scatterplots.  This plots a point on an (x,y) axis, where y is the response and x is the explanatory variable.  
