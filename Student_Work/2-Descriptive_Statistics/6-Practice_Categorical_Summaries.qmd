---
title: Summarizing Categorical Data - Practice
format:
  html:
    self-contained: true
...
chiro_tbl2 <- table(chiropractic$motivation, chiropractic$location)

barplot(chiro_tbl2, beside=T, legend=rownames(chiro_tbl2))
