...
1. Click to see how to [filter](../3-Data_Wrangling_Visualization/3-Filter.qmd) outliers of ht_to_wt ratio and [select](../3-Data_Wrangling_Visualization/03-Select.qmd) only the columns of interest.
